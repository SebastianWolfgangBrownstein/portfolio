    ...
    {showing ? (
        <>
            ...
            >
                ...
                <div className="relative w-auto my-6 mx-auto max-w-7xl min-w-[50%]">
                    {/* Content */}
                    <div className=" border-4 border-byzantine-dark rounded-lg shadow-lg relative flex flex-col w-full bg-byzantine-dark outline-none focus:outline-none">
                        ...
                        {/*body*/}
                        <div className="relative p-6 flex-auto bg-overlay-700 mt-1 h-100">
                                ...
                                <section className="text-left mx-8">
                                    <ul>
                                        {team && team.map((member, i) => (
                                            <li key={i} className="grid grid-cols-4 gap-x-5 w-1/2 h-16 mb-2">

const SkillSection = ({
  ...
  return (
    <div className="py-20 px-5 lg:py-16 lg:px-8">
        ...
        <h2 className="text-2xl font-secular mb-7 lg:mb-5 text-ivory">{title}</h2>
        <p className="mb-16 lg:mb-10 text-lg text-ivory">{summary}</p>

        <div className="mb-14 lg:mb-10">
            <h3 className="mb-2 text-amethyst">{specificsTitle}</h3>
        ...
        <div>
            <h3 className="mb-2 text-amethyst">{toolsTitle}</h3>

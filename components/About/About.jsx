...
const About = () => {
  return (
    <section className="flex flex-col justify-center w-full h-300 2xl:h-200 bg-gunmetal-dark text-center px-8 py-40 2xl:px-150 2xl:py-36">
        <h2 className="text-3xl lg:text-4xl text-gold font-play mb-10 lg:mb-3">Hey, I&apos;m Seb. Nice to meet you.</h2>
        <p className="text-tan text-md sm:text-lg lg:text-xl">

...
const About = () => {
  return (
    <section className="w-full h-300 lg:h-200 bg-gunmetal-dark text-center px-8 py-40 lg:px-150 lg:py-36">
        <h2 className="text-3xl lg:text-4xl text-gold font-play mb-10 lg:mb-3">Hi, I&apos;m Seb. Nice to meet you.</h2>
        <p className="text-tan text-lg lg:text-xl">
